...
import { GalleryMainStyled } from "./Gallery.styles";
import { BiAddToQueue } from "react-icons/bi";
import { MdOutlineArrowBack } from "react-icons/md";
import GalleryDisplay from "./GalleryDisplay.component";
import { useWindowWidth } from "@react-hook/window-size";
import GalleryCreate from "./GalleryCreate.component";
import GalleryEdit from "./GalleryEdit.component";
import { ToastContainer, toast } from "react-toastify";

const GalleryMain = ({ isSidebarOpen, setIsSidebarOpen }) => {
      ...
      <div className="content-body row justify-content-center w-100">
        {isCreatePageShow ? (
          <div className="col-md-8">
            <GalleryCreate setIsCreatePageShow={setIsCreatePageShow} />
          </div>
        ) : isEditPageShow ? (
          <GalleryEdit
